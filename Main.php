...
/*
 * Copyright 2010-2016 Justin Klein
 *
...
function fpf_enqueue_headerstuff()
{
    ...
    {
        wp_enqueue_script('fancybox', plugins_url(dirname(plugin_basename(__FILE__))).'/fancybox/jquery.fancybox-1.3.4.pack.js', array('jquery'), "1.3.4", true);
